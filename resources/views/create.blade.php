...
<nav class="navbar navbar-expand-lg navbar-light sticky-top d-flex bg-secondary shadow mt-1 mb-1 w-100 mh-100" id="navbar">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item">
                <a class="btn btn-secondary" href="/layout">Inicio</a>
            </li>
        </ul>
        <span class>
...
<div class="container-fluid h-auto w-100 flex-column min-vh-100" id="content">
    <form method="post" action="/createdait">
        @csrf
                    ...
                    <fieldset disabled>
                        <div class="form-row">
                            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <input type="text" name="orgao_autuador" class="form-control" placeholder={{$codigo->orgao_autuador}}>
                            </div>
                            <div class="invisible-sm col-md-2 col-lg-2 d-none d-md-inline"></div>
                            <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                <input type="text" name="cod_ait" class="form-control" placeholder={{$codigo->cod_ait}}>
                            </div>
                        </div>
                    </fieldset>
                </div>
            ...
            <div class="row row-cols- p-1 h-auto d-inline-flex mw-100 clearfix position-static flex-row align-content-center mt-5 w-75" id="content-form">
                <div class="mw-100 h-auto w-75 container-fluid d-block shadow border-dark" id="form">
                    ...
                    <fieldset disabled>
                        ...
                        <div class="form-row">
                            <div class="col-4 col-md-3">
                                <input type="text" name="matricula" class="form-control" value={{$user->matricula}} placeholder={{$user->matricula}}>
                            </div>
                            <div class="col-10 col-md-5">
                                <input type="text" name="nome" class="form-control" value={{$user->nome}} placeholder={{$user->nome}}>
                            </div>
                        </div>
                    </fieldset>
                    <br>
