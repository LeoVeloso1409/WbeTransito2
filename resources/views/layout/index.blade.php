...
<nav class="navbar navbar-expand-lg navbar-light sticky-top d-flex bg-secondary shadow-lg mt-1 mb-1 w-100 mh-100" id="navbar">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item">
                <a class="btn btn-secondary" href="/webtransito/create">Novo Ait</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-secondary" href="/webtransito">Cadastrar Usuário</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-secondary" href="/webtransito/listar">Mostrar AIT's</a>
            </li>
        </ul>
